...
setup(name='docassemble.Va5655NewFields',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/Va5655NewFields/', package='docassemble.Va5655NewFields'),
     )
